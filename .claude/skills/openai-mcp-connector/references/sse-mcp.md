# HTTP with SSE MCP Server Connections

This reference covers HTTP with Server-Sent Events Model Context Protocol (MCP) server connections for OpenAI Agents SDK.
